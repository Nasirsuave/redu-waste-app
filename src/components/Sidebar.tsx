...
export default function Sidebar({open}: SidebarProps){
   ...
   return <aside className={`bg-white border-r pt-20 border-gray-200 text-gray-800
            ...
            <div className='px-4 py-6 space-x-8'>
                {
                    sidebarItems.map((item) => (
                        <Link href={item.href} key={item.href} passHref>
                            ...
                            className={`w-full justify-start py-3 ${pathname === item.href ? 'bg-green-100 text-green-800' 
