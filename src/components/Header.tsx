...
export default function Header({ onMenuClick, totalEarnings }: HeaderProps) {
    ...
    const handleLogin = async () => {
        try {
            // First connect with Web3Auth
            await connect();
            
            // After successful connection, get user info
            if (userInfo?.email) {
                // Store email in localStorage with consistent casing
                ...
                console.error("No email provided by Web3Auth");
                    ...
                    {!isConnected ? (
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align='end'>
                                <DropdownMenuItem onClick={handleGetUserInfo} >
